 ...
 */
public class CarbonConfigAdapter implements ConfigProvider {

    private BrokerConfigProvider configProvider;

    CarbonConfigAdapter(BrokerConfigProvider configProvider) {
    ...
    private <T> T getConfig(String s, Class<T> aClass) throws ConfigurationException {
        try {
            ...
            throw new ConfigurationException("Error while reading events config", e);
        }
    }
