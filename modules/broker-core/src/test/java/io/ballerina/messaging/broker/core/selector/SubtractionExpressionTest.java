...
public class SubtractionExpressionTest {
    ...
    public void testSubtraction(Expression value1, Expression value2) throws Exception {
        SubtractionExpression a = new SubtractionExpression(value1, value2); //long value and double value
    ...
    public void testnullobject(Expression value1, Expression value2) throws Exception {
        SubtractionExpression a = new SubtractionExpression(null, value1);
        SubtractionExpression a1 = new SubtractionExpression(null, null);
        SubtractionExpression a2 = new SubtractionExpression(value2, null);
        a.evaluate(metadata);
    ...
    public void testobjecttype(Expression value1, Expression value2) throws Exception {
        ...
        SubtractionExpression a = new SubtractionExpression(value1, value2);
        a.evaluate(metadata);
