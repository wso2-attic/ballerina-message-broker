...
public class MultiplicationExpressionTest {
    ...
    public void testdivision(Expression value1, Expression value2) throws Exception {
        ...
        MultiplicationExpression a = new MultiplicationExpression(value1, value2);
    ...
    public void testnullobject(Expression value1, Expression value2) throws Exception {
        ...
        MultiplicationExpression a = new MultiplicationExpression(null, value2);
        MultiplicationExpression a1 = new MultiplicationExpression(null, null);
        MultiplicationExpression a2 = new MultiplicationExpression(value1, null);
        a.evaluate(metadata);
