 ...
 */
public final class QueueHandlerImpl extends QueueHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueueHandlerImpl.class);
    ...
    QueueHandlerImpl(Queue queue, BrokerMetricManager metricManager) {
