 ...
 * two expression values and evaluate to a boolean value.
 */
...
public class BetweenComparision implements BooleanExpression {
    ...
    public BetweenComparision (Expression<Metadata> left , Expression<Metadata> ltr1 , Expression<Metadata> ltr2) {
        this.left = left;
        this.ltr2 = ltr2;
        this.ltr1 = ltr1;
