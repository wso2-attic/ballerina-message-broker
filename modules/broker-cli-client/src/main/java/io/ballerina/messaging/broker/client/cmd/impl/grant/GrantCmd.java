 ...
 */
@Parameters(commandDescription = "Grant permissions for resources in the Broker")
public class GrantCmd extends AbstractCmd {

    public GrantCmd(String rootCommand) {
        super(rootCommand);
    }
    ...
    public void execute() {
        if (!help) {
            throw Utils.createUsageException("a resource type is expected after 'grant'", rootCommand);
        }
        processHelpLogs();
    }
