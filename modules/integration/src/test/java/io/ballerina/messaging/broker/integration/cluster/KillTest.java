...
public class KillTest {
    ...
    public void testNodeOneAvailableBeforeKill(String portOne, String hostnameOne) {
    ...
    public void testNodeTwoAvailableBeforeKill(String portTwo, String hostnameTwo) {
    ...
    public void testKillNodeOne(String portOne, String hostnameOne) throws IOException, InterruptedException {
        ClusterUtils.killBrokerNode(portOne);
