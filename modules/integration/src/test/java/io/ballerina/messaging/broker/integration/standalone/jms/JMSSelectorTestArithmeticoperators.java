...
public class JMSSelectorTestArithmeticoperators {
    ...
    public void testMultipleSelectorConsumersForTopic(String port,
        ...
        TopicSubscriber consumer1 = subscriberSession.createSubscriber(topic, "Age - 1 + 11 <> 210", false);
        TopicSubscriber consumer2 = subscriberSession.createSubscriber(topic, "Age * 2 / 4 > 50", false);
        TopicSubscriber consumer3 = subscriberSession.createSubscriber(topic, "E + 1 BETWEEN 760 AND 770", false);
        ...
        String consumer3Message = "Employee number add 1 is between 760 and 770 John group";
