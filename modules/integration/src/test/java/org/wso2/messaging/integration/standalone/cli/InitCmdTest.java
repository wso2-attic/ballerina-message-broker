...
public class InitCmdTest {
    ...
    public void testCorruptedConfig() {
        System.setProperty(CLI_CONFIG_SYSTEM_PROPERTY, INVALID_CONFIG_PATH);
    ...
    public void testInitCmdNoParam() {
        System.setProperty(CLI_CONFIG_SYSTEM_PROPERTY, TEMP_CONFIG_DIR + "cli-config1.yaml");

        String[] cmd = { "init" };

        org.wso2.broker.client.Main.main(cmd);
        Configuration configuration = org.wso2.broker.client.utils.Utils.readConfigurationFile();
    ...
    public void testInitCmdWithParam() {
        System.setProperty(CLI_CONFIG_SYSTEM_PROPERTY, TEMP_CONFIG_DIR + "cli-config2.yaml");
